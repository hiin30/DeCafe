        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <!-- Tombol Terima -->
                    <button
                        class="<?php echo ($row['status'] == 1) ? "btn btn-primary btn-sm me-1" : "btn btn-secondary btn-sm me-1 disabled"; ?>"
                        onclick="window.location.href='proses/update_status.php?id_bayar=<?php echo $row['id_bayar']; ?>&status=2';">
                        Terima
                    </button>

                    <!-- Tombol Siap Saji -->
                    <button
                        class="<?php echo ($row['status'] == 2) ? "btn btn-success btn-sm me-1" : "btn btn-secondary btn-sm me-1 disabled"; ?>"
                        onclick="if (confirm('Yakin ingin mengubah status menjadi Siap Saji?')) {
                            window.location.href='proses/update_status.php?id_bayar=<?php echo $row['id_bayar']; ?>&status=3';
                        }">
                        Siap Saji
                    </button>
                </div>
